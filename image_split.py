...
# # ✅ Load train metadata
# metadata_path = 'metadata/train_metadata_view_position.json'
...
# # ✅ Load train metadata
# metadata_path = 'metadata/test_metadata_view_position.json'
# with open(metadata_path, 'r') as f:
...
# ✅ Load train metadata
metadata_path = 'metadata/valid_metadata_view_position.json'
with open(metadata_path, 'r') as f:
