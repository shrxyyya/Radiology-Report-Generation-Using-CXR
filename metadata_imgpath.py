...
# with open('metadata/train_metadata_view_position.json', 'r') as f:
...
# # Load existing metadata
# with open('metadata/test_metadata_view_position.json', 'r') as f:
#     metadata = json.load(f)
...
# Load existing metadata
with open('metadata/valid_metadata_view_position.json', 'r') as f:
    metadata = json.load(f)
